...
export function AppBar({ onMenuClick, showMenuButton = false }: AppBarProps) {
    return (
        <header className="h-16 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 flex items-center justify-between px-4 transition-colors">
